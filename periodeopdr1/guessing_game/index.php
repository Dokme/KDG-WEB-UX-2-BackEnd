...
ENDPAGE;
    ...
    function killPlayer($word) {
        ...
        <body>
            <h1>You lost!</h1>
            <p>The word you were trying to guess was <strong>$word</strong>.</p>
            <form>
                <input type="button" name="gameRestart" value="Again" onClick="document.location.href='./index.php'" />
            </form>
        </body>
        </html>
...
ENDPAGE;
    ...
    function congratulateWinner($word) {
        ...
        <body>
            <h1>You win!</h1>
            <p>Congratulations! You guessed that the word was <strong>$word</strong>.</p>
            <form>
            <input type="button" name="gameRestart" value="Again" onClick="document.location.href='./index.php'" />
            </form>
        </body>
